  ...
  return (
    <aside className={cn("flex w-64 shrink-0 flex-col border-white/10 bg-sidebar/95 backdrop-blur-xl", isDrawer ? "h-full border-r-0" : "sticky top-0 hidden h-dvh border-r md:flex")}>
      <div className="flex items-center gap-2 px-5 py-5">
        <div className="flex size-6 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500/30 to-blue-500/30 ring-1 ring-white/10">
          <Brain className="size-3 text-emerald-300" />
        </div>
        <div>
